...
public class VehicleResponse {
    ...
    public VehicleResponse(String vehicleId, String transportationDetailsId, double vehicleDistanceTravelled, String vehicleFuelType, double vehicleAvgMileage, boolean pollutionCleared, boolean maintenanceDone, double vehicleCarbonEmission, double vehicleReducedCarbonEmission) {
        this.vehicleId = vehicleId;
        this.transportationDetailsId = transportationDetailsId;
        this.vehicleDistanceTravelled = vehicleDistanceTravelled;
        this.vehicleFuelType = vehicleFuelType;

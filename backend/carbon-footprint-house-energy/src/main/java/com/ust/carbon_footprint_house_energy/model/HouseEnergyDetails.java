...
public class HouseEnergyDetails {
    ...
    public HouseEnergyDetails() {
    }

    public HouseEnergyDetails(String houseId, double houseElectricity, String houseElectricityType, double houseNaturalGas, String houseNaturalGasType, double totalHouseEmission, String statisticsId) {
        this.houseId = houseId;
        this.houseElectricity = houseElectricity;
        this.houseElectricityType = houseElectricityType;
        this.houseNaturalGas = houseNaturalGas;
